...
begin
 ...
 //For at doUpdateTimers() ikke skal flytte på tiden
  setUpdateInhbit(TRUE);  //Usikkert om denne er nødvendig
 ...
 //minus ca 2 sek. for å være sikker på at player ligger foran cue punkt
...
begin
 ...
 //Av ukjent årsak er inetrvallet 1 sekund
 ...
 begin
  ...
  //Korriger for start fordi første skifte fra 0 til 1 sekund
  //kan komme før antall frames er 25
  if (getInfo) OR
