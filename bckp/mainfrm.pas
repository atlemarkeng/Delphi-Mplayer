...
var
 ...
 rt,frms,frms_tot,frmi,frms_tc,frms_dif: Integer;
...
//denne er ikke helt rutenøyaktig ...
 ...
 if not TCfileTimer.Enabled then
  ...
  begin
   if (trunc(PRV_last_time)=0) AND (timepos>=1) and
   ...
   begin
     ...
     begin
       ...
       str :=format('%s "%s %d ruter" %d %d',[OSD_SHOW_TXT,'TC feil',frms_dif,2000,1]);
       FMplayer.SendCommand(str);

     end;

      //setMediaOffset(frms_dif);
