...
{$IFNDEF DVC}
 ...
 // constructor Create(AOwner: TComponent); override;
  ...
  function  deciTimeToFrames(tm: Real; last_frms: Integer): Integer;
...
//Tidskode fra WMV filer

//public class Form1 : System.Windows.Forms.Form
 {
  private AxWMPLib.AxWindowsMediaPlayer axWMP;
  private WMPLib.IWMPControls3 mycontrols3;
....
//public Form1()
  {
   mycontrols3 = (WMPLib.IWMPControls3)axWMP.Ctlcontrols;
   tbSMPTE.Text = mycontrols3.currentPositionTimecode.ToString();
   axWMP.Ctlcontrols.play();
   mycontrols3.currentPositionTimecode = "01:56:53.15";
  }
...
//  private void button1_Click(object sender, System.EventArgs e)
  {
   textBox1.Text = mycontrols3.currentPositionTimecode.ToString();
   mycontrols3.currentPositionTimecode = "01:56:53.15";
  }
// }
//}
...
function TunitFrm.deciTimeToFrames(tm: Real; last_frms: Integer): Integer;
var
 frms,sec: Integer;
 dif: Real;
begin
 ...
 //Sjekk om avrunding kan ha gått feil vei 
 if last_frms<>0 then
 begin

  if frms=last_frms then
   frms :=trunc(tm*VIDEO_FRAME_RATE);

  if frms=last_frms then
   frms :=ceil(tm*VIDEO_FRAME_RATE);
